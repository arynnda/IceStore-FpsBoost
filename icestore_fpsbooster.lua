...
local function createOverlay()
    ...
    -- buatkan frame terpisah untuk tombol agar tetap muncul
    local controlGui = Instance.new("ScreenGui")
    controlGui.Name = "IceStoreToggleGUI"
...
local function toggleOverlay()
    ...
    if overlayOn then
        ...
        local mainGui = game:GetService("CoreGui"):FindFirstChild("IceStoreBlackModeGUI")
